...
export const siteConfig = {
  ...
  mapUrl: "https://maps.app.goo.gl/mqaEQeBPwvNN8BsRA",
  mapEmbed:
    "https://maps.google.com/maps?q=Gabriel+Garcia+Moreno+y+Federico+Gonzalez+S1-80,+Quito,+Ecuador&t=&z=16&ie=UTF8&iwloc=&output=embed",
